...
public class EasyCamera {
    ...
    /**
     * @param tmp 取景框的ratio，高宽比
     */
    public EasyCamera SetTmp(int tmp) {
        mCameraBundle.putInt(EXTRA_TMP, tmp);
        return this;
    }
     ...
     * @return
     */
    public static String getOutputUrl(@NonNull Intent intent) {
        return intent.getStringExtra(EXTRA_OUTPUT_URI);
    }
